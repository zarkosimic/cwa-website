...
![Corona-Warn-App Components](/assets/img/docs/CWA_Components.png "Corona-Warn-App Components")
...
![Figure 1: High-level architecture overview](/assets/img/docs/figure_1.svg "Figure 1: High-level architecture overview")
...
![Figure 2: Interaction flow for verification process](/assets/img/docs/figure_2.svg "Figure 2: Interaction flow for verification process")
...
![Figure 3: Data flow for the verification process](/assets/img/docs/figure_3.svg "Figure 3: Data flow for the verification process")
...
![Figure 4: Verification process for teleTAN received via phone](/assets/img/docs/figure_4.svg "Figure 4: Verification process for teleTAN received via phone")
...
![Figure 5: Upload schedule for Temporary Exposure Keys (Diagnosis Keys)](/assets/img/docs/figure_5.svg "Figure 5: Upload schedule for Temporary Exposure Keys (Diagnosis Keys)")
...
![Figure 6: Actors in the system, including external parties (blue components to be open-sourced)](/assets/img/docs/figure_6.svg "Figure 6: Actors in the system, including external parties (blue components to be open-sourced)")
...
![Figure 7: Interaction of the mobile application(s) with the backend servers and CDN](/assets/img/docs/figure_7.svg "Figure 7: Interaction of the mobile application(s) with the backend servers and CDN")
...
![Figure 8: Data format (protocol buffer) specified by Apple/Google](/assets/img/docs/figure_8.svg "Figure 8: Data format (protocol buffer) specified by Apple/Google")
...
![Figure 9: Architecture overview of the mobile application (focused on API usage/BLE communication)](/assets/img/docs/figure_9.svg "Figure 9: Architecture overview of the mobile application (focused on API usage/BLE communication)")
...
![Figure 10: Key flow from the sending perspective (as described in the specification by Apple/Google)](/assets/img/docs/figure_10.svg "Figure 10: Key flow from the sending perspective (as described in the specification by Apple/Google)")
...
![Figure 11: Key flow from the receiving perspective (as described in the specification by Apple/Google)](/assets/img/docs/figure_11.svg "Figure 11: Key flow from the receiving perspective (as described in the specification by Apple/Google)")
...
![Figure 12: Calculation of the risk](/assets/img/docs/figure_12.svg "Figure 12: Calculation of the risk")
...
![Figure 13: Limitations of the Bluetooth Low Energy approach](/assets/img/docs/figure_13.svg "Figure 13: Limitations of the Bluetooth Low Energy approach")
